...
import { Music, Smile, Shuffle, MessageSquare } from "lucide-react";
import { MediaTab, AudioTab, TextTab, StickersTab, TransitionsTab, CaptionsTab, type TabType, MediaTabProps } from "../media-tabs";
